...
}): `[`IMiddleware`](-i-middleware.md)`<`[`GlobalState`](create-logging-middleware.md#GlobalState)`>` [(source)](https://github.com/protoman92/KotlinRedux/tree/master/common/common-core/src/main/kotlin/org/swiften/redux/core/LoggingMiddleware.kt#L40)
