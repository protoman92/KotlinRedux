[docs](../../index.md) / [org.swiften.redux.saga.common](../index.md) / [DelayEffect](./index.md)
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `DelayEffect(millis: `[`Long`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-long/index.html)`)`<br>[ISagaEffect](../-i-saga-effect.md) whose [ISagaOutput](../-i-saga-output/index.md) delays emissions by [millis](millis.md). |

### Properties

| Name | Summary |
|---|---|
| [millis](millis.md) | `val millis: `[`Long`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-long/index.html)<br>Delay time in milliseconds. |
