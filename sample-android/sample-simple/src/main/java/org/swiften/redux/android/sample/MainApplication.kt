...
import org.swiften.redux.android.ui.lifecycle.IBundleStateSaver
...
class MainApplication : Application() {
  override fun onCreate() {
    ...
    val stateSaver = object : IBundleStateSaver<Redux.State> {
      override fun saveState(bundle: Bundle, state: State) {}
      override fun restoreState(bundle: Bundle): State? = null
    }
